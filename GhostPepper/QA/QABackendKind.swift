...
enum QABackendKind: String, CaseIterable, Identifiable {
    case local
    ...
    var displayName: String {
        ...
        case .claudeAPI: return "Claude API (cloud)"
        }
    }
}
...
// Transitional shim: removed in Task 13 when AppState/MeetingTranscriptWindow
// switch to consuming QAEvent directly.
enum QAStreamEvent {
    case text(String)
    case usage(QAUsage)
}
